Ext.onReady(function() {
	...
	function Add_item(record) {
		// Check if items are already 18
		if(grid.getStore().count() == 18) {
			Ext.Msg.show({
				title: 'Information',
						...
						vattable_items_html = '\
							...
							<table class="table table-bordered" style="margin-bottom: 0;">\
								...
								<tbody>\
									' + vattable_items_html_items + '\
									<tr>\
										<td colspan="4" style="padding: 0px; line-height: 15px;"></td>\
										<td style="padding: 0px; line-height: 15px;"><strong>Total</strong></td>\
